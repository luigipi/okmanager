export default [
  ...
  },
  {
    path: '/user-login',
    name: 'user-login',
    component: () => import('@/views/apps/user/UserLogin.vue'),
    meta: {
      layout: 'full',
      // resource: 'Auth',
  ...
  },
  {
    path: '/pages/users',
    name: 'pages-users',
    component: () => import('@/views/pages/account-setting/Users.vue'),
    meta: {
      pageTitle: 'Users',
    },
  },
  {
    path: '/pages/earnings',
    name: 'pages-earnings',
    component: () => import('@/views/pages/earnings/Earnings.vue'),
    meta: {
      pageTitle: 'OkPay Earning',
    },
  },
]
